...
It was announced on 18 March 2013. It was supported in CrystalPA (kitkat) and now supported by CrystalPA2 (lollipop).
...
This branch is for building CrystalPA2 (or Android Lollipop 5.0 AOSPA based roms).
